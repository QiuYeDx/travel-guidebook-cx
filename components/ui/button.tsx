...
import { smoothCorners as createSmoothCorners } from "@qiuyedx/smooth-corners";
...
const buttonCornerStyle = createSmoothCorners(8, 0.7) as React.CSSProperties;
...
function Button({
  ...
  return (
    <Comp
      ...
      style={smoothCorners ? { ...buttonCornerStyle, ...style } : style}
      {...props}
    />
  );
}
